ЗАДАНИЯ 1–5 — интерактивный тренажёр ОГЭ

Текущая версия:
- сохранён исходный дизайн «Математика без стресса»;
- первый экран теперь предлагает выбрать сюжет;
- после сюжета выбирается режим: изучение прототипа или самостоятельная работа;
- весь существующий тренажёр «Шины» сохранён;
- добавлен сюжет «Печь для бани»;
- для печей используются только 10 заданий из предоставленного архива: по два варианта на №1–5;
- файл pech.js содержит общий экран выбора и новый сюжет;
- исходные изображения печей находятся в assets/pech.
- раздел «Разбираем условие» для печей состоит из 14 последовательных шагов: сюжет, размеры, лишние данные, все столбцы таблицы, интервалы, дополнительные расходы, сравнение цен, проценты и геометрия арки.

ШИНЫ v2 — исходный интерактивный тренажёр ОГЭ
